...
class ImmutableInstaller:
    ...
    def install(self, cuda_config: str) -> Tuple[bool, str]:
        ...
        try:
            ...
            self._install_packages(cuda_config, venv_python)
    ...
    def _install_packages(self, cuda_config: str, venv_python: Path):
        """
        ...
        for dep in deps:
            ...
            installed_count += 1
            progress = f"[{installed_count}/{total_count}]"
